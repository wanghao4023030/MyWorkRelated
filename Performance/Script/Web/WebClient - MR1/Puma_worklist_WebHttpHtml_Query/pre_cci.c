# 1 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c"
...
# 1 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c" 2
...
# 2 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c" 2
...
# 3 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c" 2
...
# 4 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c" 2
...
Action()
{
 ...
 web_add_auto_header("Authorization","bearer {access_token}");
	...
	if (strcmp(lr_eval_string( "{WorklistQueryRand}"),"1") == 0){
		...
		lr_end_transaction("WorlkList_Query_randomTime",2);
...
if (strcmp(lr_eval_string( "{WorklistQueryRand}"),"2") == 0){	
	...
	lr_end_transaction("Worklist_Query_Today",2);
	...
	lr_save_datetime("%Y-%m-%d", 0 - (86400*2), "LastTwoTime");
	...
	lr_end_transaction("worklist_query_LastTwoToday",2);
	...
	lr_save_datetime("%Y-%m-%d", 0 - (86400*7), "Lastweek");
	...
	lr_end_transaction("worklist_query_Lastweek",2);
	...
	lr_end_transaction("worklist_query_LastMonth",2);
	...
	lr_end_transaction("worklist_query_Patient_PID",2);
	...
	lr_end_transaction("worklist_query_Patient_PatientName",2);
	...
	lr_end_transaction("worklist_query_ACC",2);
...
# 5 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c" 2
...
# 6 "d:\\performance\\mr1\\webclient - mr1\\puma_worklist_webhttphtml_query\\\\combined_Puma_worklist_WebHttpHtml_Query.c" 2
