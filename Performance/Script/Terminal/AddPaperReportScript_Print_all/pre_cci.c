# 1 "d:\\scripts\\releasescripts\\addpaperreportscript_print_all\\\\combined_AddPaperReportScript_Print_all.c"
# 1 "globals.h" 1
...
# 1 "d:\\scripts\\releasescripts\\addpaperreportscript_print_all\\\\combined_AddPaperReportScript_Print_all.c" 2
...
# 4 "d:\\scripts\\releasescripts\\addpaperreportscript_print_all\\\\combined_AddPaperReportScript_Print_all.c" 2
	...
	web_set_max_html_param_len("809400");
			...
			if (SQLresult ==1) {
					...
					web_custom_request("Update report printerInfo",
						"URL=http://10.184.129.108/EHDUS/upload/printer/report/info?tid={TerminalID}",
						"Method=POST",
						"TargetFrame=",
						"Resource=0",
						"Referer=",
				...
				lr_end_transaction("Report Update report printer info", 2);
				...
				lr_start_transaction("Report Update report printer info");
					...
					web_custom_request("Terminal_status",
						"URL=http://10.184.129.108/EHDPS/status?tid={TerminalID}",
						"Method=GET",
						"TargetFrame=",
						"Resource=0",
						"Referer=",
					...
					lr_end_transaction("Report TerminalStatus", 2);
        			...
        			web_custom_request("Item_query",
						"URL=http://10.184.129.108/EHDPS/printtask/items?Value=A{TreatmentID_new}&Type=0&tid={TerminalID}",
					...
					lr_end_transaction("Report QueryFilmReportInfo", 2);
					
					if(stricmp(lr_eval_string("{ReportPath}") ,"") ==0)
					{
				
						lr_start_transaction("Report GetReportPath_fail");
							lr_error_message("The accession number is %s,%s",lr_eval_string("A{TreatmentID_new}"),lr_eval_string("{TerminalID}"));
						lr_end_transaction("Report GetReportPath_fail", 2);
					};
					...
					if(stricmp(lr_eval_string("{ReportID}") ,"") ==0)
					{
						...
						lr_start_transaction("Report GetReportID_fail");
							lr_output_message("The accession number is %s,%s",lr_eval_string("A{TreatmentID_new}"),lr_eval_string("{TerminalID}"));
						lr_end_transaction("Report GetReportID_fail", 2);
					};
...
# 588 "Action.c"
					...
					web_custom_request("web_custom_request",
						"URL=http://10.184.129.108/EHDPS/printtask/create?tid={TerminalID}",
						"Method=POST",
						"TargetFrame=",
						"Resource=0",
						"Referer=",
					...
					lr_end_transaction("Report Create_PrintTask", 2);
					...
					if(stricmp(lr_eval_string("{TaskID}") ,"") ==0){
						...
						lr_end_transaction("Create Report PrintTask Fail",2);
					...
					if (stricmp(lr_eval_string("{TaskID}") ,"")!=0) {
							...
							web_custom_request("web_custom_request",
											"URL=http://10.184.129.108/EHDPS/printtask/print/{TaskID}?tid={TerminalID}",
											"Method=POST",
											"TargetFrame=",
											"Resource=0",
											"Referer=",
							...
							lr_end_transaction("Report PrintTask", 2);
							...
							web_custom_request("web_custom_request",
											"URL=http://10.184.129.108/EHDPS/printtask/report/{TaskID}/{ReportID}/1?tid={TerminalID}",
											"Method=POST",
											"TargetFrame=",
											"Resource=0",
											"Referer=",
							...
							lr_end_transaction("Report Update PrintTask", 2);
							...
							do{
									...
									lr_start_transaction("Report PrintTask Status Check");
									   ...
									   web_reg_save_param("TaskStatus",
										...
										web_custom_request("web_custom_request",
											"URL=http://10.184.129.108/EHDPS/printtask/status/{TaskID}?tid={TerminalID}",
											"Method=GET",
											"TargetFrame=",
											"Resource=0",
											"Referer=",
										...
										lr_end_transaction("Report PrintTask Status Check", 2);
						...
						if(result ==0 ){
								...
								lr_think_time(1);
								lr_end_transaction("Report  Print Task Correct",2);
							...
							if (LoopNumber >12) {
								...
								lr_end_transaction("Report  Print Task fail",2);
...
# 5 "d:\\scripts\\releasescripts\\addpaperreportscript_print_all\\\\combined_AddPaperReportScript_Print_all.c" 2
...
# 6 "d:\\scripts\\releasescripts\\addpaperreportscript_print_all\\\\combined_AddPaperReportScript_Print_all.c" 2
