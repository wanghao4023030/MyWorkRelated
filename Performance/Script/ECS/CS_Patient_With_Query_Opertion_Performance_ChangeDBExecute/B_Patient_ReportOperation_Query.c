...
//							
//		
//					lr_end_transaction("Report Create Paper report", LR_AUTO);
//					
...
//						LAST);
//					
//					lr_end_transaction("Report QueryReportFilmStatus", LR_AUTO);
//					
//					// Get the http response status and check the value.
//					HTTP_RC = web_get_int_property(HTTP_INFO_RETURN_CODE);
//					
...
////					{
////						lr_fail_trans_with_error("Report QueryReportFilmStatus_failed.");
////						lr_exit(LR_EXIT_ITERATION_AND_CONTINUE,LR_FAIL);
////						return 0;
////					}
//
...
//									LAST);
//									
//							lr_end_transaction("Report Update Paper report", LR_AUTO);
//							
//							// Get the http response status and check the value.
//							HTTP_RC = web_get_int_property(HTTP_INFO_RETURN_CODE);
//			
