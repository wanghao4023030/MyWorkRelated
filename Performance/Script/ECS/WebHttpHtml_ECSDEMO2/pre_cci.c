# 1 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c"
...
# 1 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2
...
# 2 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2
...
# 3 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2
...
# 5 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2

# 1 "PUMA_PaperReport.c" 1
PUMA_PaperReport()
{
		...
		for(i = 1 ; i <= LoopNumber; i++)
		{
				...
				lr_end_transaction("Create Paper report", 2);
		...
		for(i = 1 ; i <= LoopNumber; i++)
		{
				...
				lr_end_transaction("Update Paper report", 2);

		}	

	return 0;
}
# 6 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2
...
PUMA_Film()
{
		...
		for(i = 1 ; i <= LoopNumber; i++)
		{
				...
				lr_end_transaction("Create Film", 2);
		...
		for(i = 1 ; i <= LoopNumber; i++)
		{
				...
				lr_end_transaction("Update Film", 2);

		}	

	return 0;
}
# 7 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2

# 1 "PUMA_examreservation.c" 1
...
# 8 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2
...
# 9 "d:\\ecs\\webhttphtml_ecsdemo2\\\\combined_WebHttpHtml_ECSDEMO2.c" 2
