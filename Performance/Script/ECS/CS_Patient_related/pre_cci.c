# 1 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c"
...
# 1 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2
...
# 2 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2
...
# 3 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2
...
# 5 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2

# 1 "PatientOperations.c" 1
PatientOperations()
{
	...
	int ExecuteRand;
		...
		if(mysql_num_rows(query_result) == 1)
		{
			...
			for(i = 1 ; i <= LoopNumber; i++)
			{
					...
					lr_end_transaction("QueryReportFilmStatus", 2);
			...
			lr_start_transaction("QueryExamReservation");
					...
					lr_end_transaction("QueryExamReservation", 2);
...
# 6 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2
...
# 7 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2
...
# 8 "d:\\ecs\\cs_patient_related\\\\combined_CS_Patient_related.c" 2
