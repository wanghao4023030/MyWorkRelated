# 1 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c"
...
# 1 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
# 2 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
# 3 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
# 5 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
	...
	int flags = 0;  
	  ...
	  if (rc == 0) {
		...
		lr_save_string(lr_eval_string("{Para}"),"TimeStamp");
  			...
  			lr_end_transaction("Subscribe_Patinet", 2);
...
# 6 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
# 7 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
# 8 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
D_Patient_Reservation_Query()
{
	...
	int ExecuteRand;
		...
		for(i = 1 ; i <= LoopNumber; i++)
		{
				...
				lr_end_transaction("Create ExamReservation", 2);
				...
				if(HTTP_RC == 200 && strcmp(lr_eval_string("{HttpResultCreateExamReservation}"),"true") != 0)
				{
					...
					lr_start_transaction("QueryReservation");
					...
					lr_end_transaction("QueryReservation", 2);
					...
					{
						lr_start_transaction("QueryReservation_Pass");
						lr_end_transaction("QueryReservation_Pass", 2);
					}
					else
					{
		...
		if(ExecuteRand == 1)
		{
			for(i = 1 ; i <= LoopNumber; i++)
			{
					...
					lr_end_transaction("Update ExamReservation", 2);
...
# 9 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
...
# 10 "d:\\ecs\\cs_patient_query_opertion\\\\combined_CS_Patient_Query_opertion.c" 2
