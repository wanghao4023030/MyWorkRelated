...
*/
 ...
 web_add_auto_header("Authorization","bearer {access_token}");
	...
	lr_end_transaction("Film_By_ModalityType", LR_AUTO);
	...
	lr_end_transaction("Film_By_ModalityName", LR_AUTO);
	...
	lr_end_transaction("Film_By_Terminal", LR_AUTO);
	...
	lr_end_transaction("Film_By_FilmSize", LR_AUTO);
	...
	lr_end_transaction("Film_Unprinted_By_FilmSize", LR_AUTO);
	...
	lr_end_transaction("Film_printed_By_CentralPrint", LR_AUTO);
	...
	lr_end_transaction("Report_By_ModalityType", LR_AUTO);
	...
	lr_end_transaction("Report_By_Terminal", LR_AUTO);
	...
	lr_end_transaction("Report_By_PaperSize", LR_AUTO);
	...
	lr_end_transaction("Report_By_CentralPrint", LR_AUTO);
	...
	lr_end_transaction("OCR_ModalityType", LR_AUTO);
	...
	lr_end_transaction("OCR_ModalityName", LR_AUTO);
