...
IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[T_Integration_ExamInfo]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
	DROP TABLE [dbo].[T_Integration_ExamInfo]
END
GO
