...
GO
IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[T_Integration_Dictionary]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
--add by ralf
begin 
	drop table [dbo].[T_Integration_Dictionary];
end 
BEGIN
