...
Func LoadAutoBatCfg()
	...
	$_InstallToolName=IniRead($_szCurPath & "\" & $strCfgFileName,$strPlatformCfg,"ToolName","PrinterServer3.0-Setup.exe")
...
$controlIDForRestart="[ID:502]"
FindWindowFunc($LogFile,$dlgInstallShieldWindow,$dlgInstallShieldWindowText,2400)

FindButtonToClick($LogFile,$dlgInstallShieldWindow,$dlgInstallShieldWindowText,$controlIDForRestart,"Restart Button")
