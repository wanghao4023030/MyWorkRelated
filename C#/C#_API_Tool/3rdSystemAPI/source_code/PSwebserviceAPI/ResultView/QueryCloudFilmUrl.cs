...
namespace QueryCloudFilmUrl
{
    class CloudFilmUrl
    {
        ...
        public string GetUrl(string strURL, string strACCN, string strPID)
        {
            try
            {
                ...
                string postData = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
                                    ...
                                    "<soap:Header><wsa:Action>http://carestream.org/QueryCloudFilmUrl</wsa:Action>" +
                                    "<wsa:MessageID>uuid:639a1da0-ac2a-4ed4-99bd-5a8b86a4a284</wsa:MessageID>" +
                                    "<wsa:ReplyTo><wsa:Address>http://schemas.xmlsoap.org/ws/2004/03/addressing/role/anonymous</wsa:Address></wsa:ReplyTo>" +
                                    "<wsa:To>http://10.184.129.108/NotifyServer/NotifyService.asmx</wsa:To></soap:Header>" +
                                    "<soap:Body>" +
                                    "<QueryCloudFilmUrl xmlns=\"http://carestream.org/\">" +
                                    "<accessionNumber>" + strACCN + "</accessionNumber>" +
