...
; connect Database
;******************************
$constrim="DRIVER={SQL Server};SERVER=10.184.129.161\GCPACSWS;DATABASE=WGGC;uid=sa;pwd=sa20021224$;"
...
for $i = 1 to 10 step 1
			...
			&')' _
			&'VALUES ' _
			&'( '&"'"&$DateDime&"'"&' , '&"'"&$DateDime&"'"&', '&"'"&$PatientID&"'"&', '&"'"&$AccnNum&"'"&', '&"'"&$StudyUID&"'"&',  '&"'"&$NameCN&"'"&', '&"'"&$NameEN&"'"&', '&"'"&$PatientSex&"'"&', '&"'"&$DateDime&"'"&', '&"'"&$PatientModality&"'"&', '&"'"&$PatientModality&"'"&',''急诊病人'',0,'''',2,'''',' _
...
Func PrintReport($PID,$ACCN)
	...
	_FilePrint($sReportPath,@SW_HIDE)
