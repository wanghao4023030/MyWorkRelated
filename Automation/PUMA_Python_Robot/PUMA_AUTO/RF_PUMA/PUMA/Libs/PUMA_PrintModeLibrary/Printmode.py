...
class Printmode(object):
    def __init__(self):
        try:
            ...
            print("Object Printmode: Object init failed.")
            print(type(e))
            raise Exception(e)
    '''
    ...
    def printmode_get_by_accn(self, accession_number):
        """printmode_get_by_accn

        This function get the exam print mode with accession number.

        :param accession_number: The exam accession number. It`s the primary key in the table


        :return: print mode type like 'both'|'any'|......
        ...
        try:
            ...
            print("Printmode.printmode_get_by_accn: Function execute failed.")
            print(type(e))
            raise Exception(e)
    ...
    def printmode_set_by_accn(self, accession_number, mode="any"):
        """printmode_set_by_accn

        This function set the exam print mode with accession number and mode. It will set to any as default.

        :param accession_number: The exam accession number. It`s the primary key in the table


        :param mode: The exam mode like both|any|....
    ...
    def printmode_get_info_from_db_by_accn(self, accession_number):
        ...
        try:
            ...
            print("Printmode.printmode_get_info_from_db_by_accn: Function execute failed.")
            print(type(e))
            raise Exception(e)
