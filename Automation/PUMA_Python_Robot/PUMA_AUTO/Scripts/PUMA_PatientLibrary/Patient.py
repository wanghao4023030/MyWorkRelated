...
class Patient(object):
    ...
    def patient_create_randomly(self):
        ...
        try:
            ...
            raise Exception("Patient.patient_create_randomly: Parepare the request parameters failed:")
            raise Exception("Patient.patient_create_randomly:The request headers is: \n" + str(headers))
            raise Exception("Patient.patient_create_randomly:The request body is: \n" + str(body))
        ...
        try:
            ...
            raise Exception("Patient.patient_create_randomly:The Http return code is:\n " + (str(status_code)))
            raise Exception("Patient.patient_create_randomly:The Http response is: \n" + str(respose.content.decode('utf-8', 'ignore')))
        ...
        try:
            ...
            if respose.status_code == 200 and NotifyExamInfoResult == 'true':
                ...
                raise Exception("Patient.patient_create_randomly: Create patient failed:\n" + str(respose.content.decode('utf-8', 'ignore')))
    ...
    def patient_delete_by_pid_accn(self, pid, accn):
        ...
        try:
            ...
            raise Exception("Patient.patient_delete_by_pid_accn: faunction execute failed.")



    #@keyword('replace exam parameter')
