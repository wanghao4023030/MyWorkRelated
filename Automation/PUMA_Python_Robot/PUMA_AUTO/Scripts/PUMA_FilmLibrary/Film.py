...
class Film(object):
    ...
    def film_create_film_with_sample(self, patient_id, accession_number):
        ...
        try:
            ...
            raise Exception("Film.film_create_film_with_sample: The Function execute failed." )
    ...
    def film_check_archive_in_filminfo_table(self):
        ...
        try:
            ...
            raise Exception("Film.film_check_archive_in_filminfo_table: Function execute failed.")
    ...
    def _create_waterBMP(self):
        try:
            if os.path.isdir(self.WaterMark_Path):
                ...
                raise Exception("film.create_waterBMP: Function execute failed." )
    ...
    def _copy_sampleDciom(self):
        try:
            if os.path.isfile(self.WaterMark_SampleDicom):
                ...
                raise Exception("film.copy_sampleDciom: The WaterMark Sample dicom (sample.dcm) is not exist:\n %s " % (self.WaterMark_SampleDicom))
        except Exception as e:
            raise Exception("film.copy_sampleDciom: Function execute failed." )
    ...
    def _add_waterMark(self):
        try:
            ...
            raise Exception("add_waterMark: Function execute failed." )
    ...
    def _printer_createDCM(self):
        try:
           if os.path.isfile(self.SCU_dcmpsprt_app):
            ...
            raise Exception("film.filmprint_createDCM: Function execute failed.")
    ...
    def _printer_printDCM(self):
        try:
            ...
            raise Exception("film.printer_printDCM: Execute the function failed.")
    ...
    def _random_archive_check(self):
        try:
            ...
            raise Exception("Film.random_archive_check: The function execute failed." )
