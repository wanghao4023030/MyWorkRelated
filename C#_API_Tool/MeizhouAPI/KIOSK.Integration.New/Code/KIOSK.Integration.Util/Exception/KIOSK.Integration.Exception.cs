...
namespace KIOSK.Integration.Util
{
    ...
    /// </summary>
    public class KIOSKIntegrationException : ApplicationException
    {
        /// <summary>
        /// Initializes a new instance of the System.ApplicationException class.
        /// </summary>
        public KIOSKIntegrationException()
        { }
        ...
        public KIOSKIntegrationException(string message)
            : base(message)
        { }
        ...
        protected KIOSKIntegrationException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        { }
        ...
        /// </param>
        public KIOSKIntegrationException(string message, Exception innerException)
